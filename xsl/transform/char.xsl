...
<!--     <xsl:template match="char[mt_code_value='0x2026']">
    ...
    <xsl:template match="char[mt_code_value='0x0028' and variation='mathmode']">
        <mo stretchy="false">
            <xsl:call-template name="charhex">
                <xsl:with-param name="mt_code_value" select="mt_code_value/text()"/>
            </xsl:call-template>
    ...
    <xsl:template match="char[mt_code_value='0x0029' and variation='mathmode']">
        <mo stretchy="false">
            <xsl:call-template name="charhex">
                <xsl:with-param name="mt_code_value" select="mt_code_value/text()"/>
            </xsl:call-template>
    ...
    <xsl:template match="char[mt_code_value='0x002A' and variation='mathmode']">
        <mo>
            <xsl:call-template name="charhex">
                <xsl:with-param name="mt_code_value" select="mt_code_value/text()"/>
            </xsl:call-template>
    ...
    <xsl:template match="char[mt_code_value='0x002C' and variation='mathmode']">
        <mo>
            <xsl:call-template name="charhex">
                <xsl:with-param name="mt_code_value" select="mt_code_value/text()"/>
            </xsl:call-template>
    ...
    <xsl:template match="char[mt_code_value='0x0394' and variation='mathmode']">
        <mi>
            <xsl:call-template name="charhex">
                <xsl:with-param name="mt_code_value" select="mt_code_value/text()"/>
            </xsl:call-template>
